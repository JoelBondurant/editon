...
use editor::highlight::SyntaxLanguage;
use editor::{CodeEditor, EditorMsg};
...
impl DemoApp {
    ...
    fn update(&mut self, msg: DemoMsg) -> Task<DemoMsg> {
        ...
        // Intercept F5: toggle language between SQL and Rust (demo only)
